#!/usr/bin/env python
# title           :script.py
# description     :This will continuously obtain car position and orientation
# author          :Tigmanshu
# date            :25th Oct 2016
# Last modified   :31st Oct 2016
# version         :0.1
# usage           :python scriptcommon.py
# notes           :
...
if imagesource == 'simulation':
    ...
    obs = Observer(imagesource=imagesource, pathtofile ='/home/tigmanshu/All/recordingaa.avi')
    obs.debug = debug
...
if obs.debug:
    ...
    ax1.imshow(obs.img)
    ax1.scatter([obs.pos1[0], obs.pos2[0]], [obs.pos1[1], obs.pos2[1]], s=60, c='r')https://github.com/tjp19/carcontrol.git
https://github.com/tjp19/carcontrol.git
